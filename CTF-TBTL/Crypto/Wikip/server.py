...
def main():
    ...
    print(f"TARGET: {bytes_to_long(TARGET)}")
    # 36367516023080771443785382206537484078500891673043385026763929849792665821597708151383329
